...
public class Driver extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		Slider slide = new Slider(1, 4, 1); // Slider to determine distance
		...
		/**
		 * Creating the first pane This will contain enterDist, the slider, and the text
		...
		/**
		 * Creating the second pane This will contain the show station button and the
		 * text area for its output
		 */
		pane2 = new GridPane();
		...
		/**
		 * Creating the third pane This will contain the compare with: label and the
		 * drop down box
		 */
		pane3 = new GridPane();
		...
		/**
		 * Creating the fourth pane This will contain the distance labels and text areas
		 */
		pane4 = new GridPane();
		...
		/**
		 * Creating the fifth pane This will contain the Add Station button and the text
		 * area for typing
		 */
		pane5 = new GridPane();
	...
	/**
	 * This method reads from a file and sorts through to find the station IDs in
	 * the document. It then stores each station ID in the stationID array,
	 * enlarging it when necessary.
	 * 
